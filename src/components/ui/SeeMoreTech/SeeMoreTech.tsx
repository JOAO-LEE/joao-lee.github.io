...
export function SeeMoreTech() {
  ...
  const { ref, isVisible } = useIntersectionObserver<HTMLDivElement>({ threshold: 1 });
    ...
    <>
      {
        ...
        ?
          (
            <div ref={ref} className={`space-y-5 text-center lg:place-self-center ${isVisible ? "show-content swipe-to-origin-y" : "hidden-content translate-y-14"}`}>
