      ...
      <div className="inner-content-footer">
        <div className="main-content-footer">
          <nav aria-label="Main navigation" className="space-y-1">
            <span
              data-title="Navigate"
              className={`font-styled-bold list-title-shadow ${isVisible ? "move-shadow-left-animation" : ""}`}
            >
              Navigate
            </span>
            <ul className="footer-link-list-container">
              <li>
                <Link to="/" className="footer-link-list-item">
          ...
          <address className="not-italic space-y-1">
            ...
            <ul className="footer-link-list-container">
              <li>
                <Link
                  to="mailto:joaovitor_mdk@hotmail.com"
