    ...
    >
      ...
      <div className="h-full flex flex-col justify-between gap-10">
        ...
        {/* <div className="space-y-5 mt-20">
          <h3 className={`font-styled-bold tracking-widest text-2xl title`}>TECH STACK</h3>
          <h4 className="font-styled tracking-widest text-2xl title">Frontend</h4>
         
          {/* <h4 className="font-styled tracking-widest text-2xl title">Backend</h4>
          <ul className="grid grid-cols-2 justify-items-center  gap-4 text-center">
            {
              techStack.backendTech
                .map((feTech, index) => (
                  <li key={index}>
                    <i className={`${feTech.iconClass} text-4xl text-grayish`}></i>
