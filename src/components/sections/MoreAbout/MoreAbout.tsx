...
export function MoreAbout() {
  ...
  return (
    ...
    >
      ...
      />
      <div
      className="about-texts-container text-xs lg:text-sm lg:space-y-0 mx-auto h-full lg:mx-0 ">
        <div className={`about-text ${isVisible ? "show-content show-right" : "hidden-content hidden-left hidden-down"}`}>
          <h3 className={`font-styled tracking-widest text-xl lg:text-3xl ${isVisible ? "color-yel-animation" : ""}`}>How it all started</h3>
        ...
        <p className={`font-styled text-3xl lg:text-5xl text-center about-text ${isVisible ? "show-content show-right color-yel-animation" : "hidden-content hidden-left hidden-down"}`}>&</p>
        <div className={`about-text ${isVisible ? "show-content show-right show-up" : "hidden-content hidden-left hidden-down" }`}>
          <h3 className={`font-styled tracking-widest text-xl lg:text-3xl ${isVisible ? "color-yel-animation" : ""}`}>how it's been.</h3>
          <article className={`${isVisible && "about-article"} text-justify space-y-3`}>
          <p>
