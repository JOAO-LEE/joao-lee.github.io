...
export function Intro() {
  return (
    <section 
    className="intro flex flex-col justify-center px-4 py-8 lg:px-8 lg:py-4 h-screen"
    data-header-title="home"
    >
      <div 
      className="font-titles greeting-container space-y-1" 
      >
        <h1 className="text-2xl lg:text-6xl lg:mb-6">João Lima<span className="colored-dot-texts font-tipography">.</span>
        </h1>
        <h2
        ...
        <p className="text-sm lg:text-2xl">Passionate about learning modern technologies & building impactful, clean applications with.</p>
      </div>
    </section> 
  )
}
